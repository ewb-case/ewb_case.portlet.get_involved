...
#from ewb_case.static_portlets.static_portlets import DontateEwbMessageFactory as _


class IDontateEwb(IPortletDataProvider):
    """A portlet
...
class Assignment(base.Assignment):
    ...
    def title(self):
        ...
        """
        return "EWB Main Donate Portlet"
...
class Renderer(base.Renderer):
    ...
    render = ViewPageTemplateFile('dontateewb.pt')
...
class AddForm(base.AddForm):
    ...
    """
    form_fields = form.Fields(IDontateEwb)
